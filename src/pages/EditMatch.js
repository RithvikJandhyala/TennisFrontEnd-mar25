...
const EditMatch = ({editedMatch,setShowEdit,setShowAdd,showEdit}) => {
  ...
  const [matchType,setMatchType] = useState(editedMatch.matchType);
  ...
  const saveMatch = (e) => {
        e.preventDefault();
        const match = {matchID,matchType,player1Name,player2Name,status,court,player1Score,player2Score}
        console.log(match)
